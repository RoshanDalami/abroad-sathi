...
export default function Topdestination(){
    return(
        <div className="flex flex-col items-center justify-center gap-10 my-10 flex-wrap  ">
            <section>
                <Image src={underline} alt="underline" className="absolute ml-[245px] mt-[45px]"/>
                <h1 className="text-[40px] font-bold text-[#3D3D3D]">TOP DESTINATIONS</h1>
            </section>
            <section className="flex items-center justify-center gap-24 flex-wrap ">
                <section>
                    <Image src={ausflag} alt="austraila flag"/>
                    <h1 className="text-[28px] text-center mt-3 font-bold text-[#3D3D3D]" >AUSTRALIA</h1>
                </section>
                <section>
                    <Image src={usaflag} alt="United states  flag"/>
                    <h1 className="text-[28px] text-center mt-3 font-bold text-[#3D3D3D]" >USA</h1>
                </section>
                <section>
                    <Image src={canadaflag} alt="Canada flag"/>
                    <h1 className="text-[28px] text-center mt-3 font-bold text-[#3D3D3D]" >CANADA</h1>
                </section>
                <section>
                    <Image src={ukflag} alt="United kingdom flag"/>
                    <h1 className="text-[28px] text-center mt-3 font-bold text-[#3D3D3D]" >UK</h1>
                </section>
                <section>
                    <Image src={denmarkflag} alt="Denmark flag"/>
                    <h1 className="text-[28px] text-center mt-3 font-bold text-[#3D3D3D]" >DENMARK</h1>
                </section>

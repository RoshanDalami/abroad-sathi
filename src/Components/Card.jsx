...
export default function Card({image,title,description,title2}){
    return(
        <div className="rounded-lg border-2 border-[#0149A5] w-[380px] flex flex-col gap-5 items-center">
            ...
            <section className='mb-8'>
                <button className='px-3 py-1 rounded border-2 border-[#0149A5] text-[#0149A5] hover:scale-110 hover:bg-[#0149A5] hover:text-white transition ease-in-out duration-300'>KNOW MORE</button>
            </section>
        </div>
    )
}